          ...
          builder: (context, constraints) {
            ...
            final cards = [
              _ModeCard(
                icon: Icons.tv,
                title: 'TV / Remote',
                subtitle: 'Firestick, Android TV and similar',
                    ...
                    child: ConstrainedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('How are you watching?',
                              textAlign: TextAlign.center,
                              style: Theme.of(context).textTheme.headlineMedium),
                          const SizedBox(height: 8),
                          Text(
                            'We adapt navigation to your device. You can change it anytime in Settings.',
                            textAlign: TextAlign.center,
          ...
          child: Column(
            children: [
              ...
              if (suggested) ...[
                ...
                const Chip(
                  label: Text('Recommended', style: TextStyle(color: Colors.black)),
