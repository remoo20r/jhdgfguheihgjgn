  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return items.when(
      data: (list) {
        ...
        // Newest first: series that got a new episode most recently rise to the
        // top of the category (they used to sit at the bottom).
        final sorted = [...list]..sort((a, b) => b.added.compareTo(a.added));
        return _posterGrid(sorted);
      },
      loading: () => const Center(child: CircularProgressIndicator()),
