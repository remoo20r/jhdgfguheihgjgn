...
void main() {
  ...
  group('dpadAutofocusPolicy (may a screen pre-light its first element?)', () {
    ...
    test('Android detected TV: yes even if saved mode is touch', () {
      // A TV the OS reports as a television must get autofocus (working
      // remote) regardless of a stale/wrong saved "touch" mode.
      expect(
        dpadAutofocusPolicy(
